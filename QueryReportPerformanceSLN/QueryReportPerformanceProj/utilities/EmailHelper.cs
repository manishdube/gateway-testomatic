...
namespace msrb.org.queryreportperf.utilities
{
    internal class EmailHelper
    {
        ...
        private const long threadSleepTimeInMillis = 10000;

        public string DefaultIncomingImapServer
        {
            get { return ConfigurationManager.AppSettings["IncomingImapServer"]; }
        }

        public string DefaultOutboundSmtpServer
        {
            get { return ConfigurationManager.AppSettings["OutboundSmtp"]; }
        }
        ...
        public Dictionary<uint, MailMessage> SearchMessages(SearchCondition search, long waitInMillis = 0)
        {
            try
            {
